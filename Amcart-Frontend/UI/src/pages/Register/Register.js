    ...
    <div className='px-8 w-full lg:w-[70%]'>
      ...
      <div className='pt-4'>
        <form onSubmit={onSubmit} autoComplete='off'>
          ...
          <input type="text" name='firstName' value={values?.firstName} onChange={handleOnChange} placeholder='First Name' className='h-[48px] w-full border p-2 mt-2 mb-4 border-gray-400' required autoComplete='off'/>
          <label>Last Name </label>
          <input type="text" name='lastName' value={values?.lastName} onChange={handleOnChange} placeholder='Last Name' className='h-[48px] w-full border p-2 mt-2 mb-4 border-gray-400' required autoComplete='off'/>
          <label>Phone Number </label>
          <input type="tel" name='phoneNumber' value={values?.phoneNumber} onChange={handleOnChange} placeholder='Phone Number' className='h-[48px] w-full border p-2 mt-2 mb-4 border-gray-400' required autoComplete='off'/>
